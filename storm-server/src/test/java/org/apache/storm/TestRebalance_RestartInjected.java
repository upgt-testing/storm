...
public class TestRebalance_RestartInjected {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(TestRebalance_RestartInjected.class);
    ...
    public void testRebalanceTopologyResourcesAndConfigs()
        ...
        for (Class strategyClass : strategyClasses) {
            ...
            try (ILocalCluster cluster = new LocalCluster.Builder().withDaemonConf(conf).build()) {
                ...
                RestartFramework.at("after_topology_scheduled")
                    .on(cluster)
                    .restart("worker")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
                ...
                RestartFramework.at("after_rebalance_scheduled")
                    .on(cluster)
                    .restart("supervisor")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
